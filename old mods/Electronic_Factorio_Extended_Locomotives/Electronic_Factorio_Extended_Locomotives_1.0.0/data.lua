...
local electronic_extended_mk2_item = table_deepcopy(data.raw["item"]["locomotive-mk2"])
...
local electronic_extended_mk3_item = table_deepcopy(data.raw["item"]["locomotive-mk3"])
