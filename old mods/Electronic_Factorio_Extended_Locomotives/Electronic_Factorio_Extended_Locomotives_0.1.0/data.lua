...
data:extend{ electronic_extended_mk2_entity, electronic_extended_mk2_item, electronic_extended_mk2_recipe }

table.insert( data.raw["technology"]["railway-2"].effects, { type = "unlock-recipe", recipe = name } )
...
data:extend{ electronic_extended_mk3_entity, electronic_extended_mk3_item, electronic_extended_mk3_recipe }
