for _, force in pairs(game.forces) do
    ...
    if settings.startup["angels-crawlertrain-tier-amount"].value > 0 then
    ...
    if settings.startup["angels-smeltingtrain-tier-amount"].value > 0 then
        for i = 1, settings.startup["angels-smeltingtrain-tier-amount"].value do
            if i == 1 then
                ...
                if technologies["angels-smelting-train-" .. i] then
                    recipes["electronic-smelting-locomotive-1-" .. i].enabled = technologies["angels-smelting-train-" .. i].researched
