...
function Senpais_Trains_CountTrainsGUIList( parent, part )
	...
	local F04 = Senpais_Trains_Add_Table( F03, "SenpaisCountTrainsTable02", 4 )
	...
	local F05 = { Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel05", "Backer Name" ),
				  --Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel06", "Kills" ),
	...
	for u = 1, #part.entities do
		local F06 = { Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel10_" .. part.name .. "_" .. u, part.entities[u].backer_name ),
					  --Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel11_" .. part.name .. "_" .. u, part.entities[u].kills ),
					  Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel12_" .. part.name .. "_" .. u, part.entities[u].train.id ),
					  Senpais_Trains_Add_Label( F04, "SenpaisCountTrainsLabel13_" .. part.name .. "_" .. u, part.entities[u].health .. "/" .. part.entities[u].prototype.max_health ),
					  Senpais_Trains_Add_Button( F04, "SenpaisCountTrainsButton02_" .. part.name .. "_" .. u, "Edit Train" ) }
	end
end

function Senpais_Trains_CountTrainsGUIEntityEdit( parent, entity )
	if parent.children[1] then parent.children[1].destroy() end
	local G01 = Senpais_Trains_Add_Frame( parent, "SenpaisCountTrainsFrame05" )
...
function Senpais_Trains_CountTrainsGUIEntityEditList( parent, index )
	...
	local H01 = Senpais_Trains_Add_Frame( parent, "SenpaisCountTrainsFrame06", "image_frame" )
	...
	local H03 = { Senpais_Trains_Add_Label( H02, "SenpaisCountTrainsLabel11" ),
				  Senpais_Trains_Add_Label( H02, "SenpaisCountTrainsLabel12", "Stations" ) }
	for _, t in pairs( global.SenpaisScheduleLinesSignals[global.SenpaisLines[index]] ) do
		local H04 = { Senpais_Trains_Add_RadioButton( H02, "SenpaisCountTrainsRadioButton_" .. t.station ),
					  Senpais_Trains_Add_Label( H02, "SenpaisCountTrainsLabel13_" .. t.station, t.station ) }
