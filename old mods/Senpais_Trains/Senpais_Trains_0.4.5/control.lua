...
local function ONINIT()
	...
	for _, p in pairs( game.players ) do
		if settings.startup["Smarter-Trains"].value and not p.gui.top.SenpaisSmartTrainMainButton then
			p.gui.top.add{ type = "sprite-button", name = "SenpaisSmartTrainMainButton", sprite = "Senpais-Smart-Stop-Icon" }
		elseif p.gui.top.SenpaisSmartTrainMainButton and settings.startup["Smarter-Trains"].value == false then
