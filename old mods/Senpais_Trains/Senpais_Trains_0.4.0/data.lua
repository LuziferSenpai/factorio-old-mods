...
if settings["startup"]["Coupling"].value == true then
...
if settings["startup"]["Smarter-Trains"].value == true then
	data:extend{ { type = "sprite", name = "Senpais-okay", filename = MODNAME .. "/graphics/okay.png", priority = "extra-high-no-scale", width = 32, height = 32, scale = 1 },
				 { type = "sprite", name = "Senpais-plus", filename = MODNAME .. "/graphics/plus.png", priority = "extra-high-no-scale", width = 32, height = 32, scale = 1 },
				 { type = "sprite", name = "Senpais-nope", filename = MODNAME .. "/graphics/nope.png", priority = "extra-high-no-scale", width = 32, height = 32, scale = 1 },
				 { type = "sprite", name = "Senpais-Smart-Stop-Icon", filename = MODNAME .. "/graphics/smart-stop-icon.png", priority = "extra-high-no-scale", width = 32, height = 32, scale = 1 } }
end