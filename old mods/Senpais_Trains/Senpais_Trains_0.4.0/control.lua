...
local function ONINIT()
	global.Register = { { name = "Senpais-Electric-Train", multy = 1 }, { name = "Senpais-Electric-Train-Heavy", multy = 4 }, { name = "Elec-Battle-Loco-1", multy = 1 },
						{ name = "Elec-Battle-Loco-2", multy = 2 }, { name = "Elec-Battle-Loco-3", multy = 3 } }
