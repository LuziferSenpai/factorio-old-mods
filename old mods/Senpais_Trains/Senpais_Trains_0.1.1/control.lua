local MaxPower = 10666.6666666667
...
local function ONTICK()
	...
	if global.SenpaisTrainsList ~= nil and global.SenpaisAccuList ~= nil then
		...
		if PowerAvaible >= 0 then
			...
			PowerPer = PowerAvaible / #global.SenpaisTrainsList
...
script.on_init( function()
	...
	table.insert( global.Register.Trains, { name = "Senpais-Electric-Train-Heavy", multy = 3 } )
