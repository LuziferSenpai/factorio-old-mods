...
if settings["startup"]["Senpais-Electric-Train-Heavy"].value == true then
	...
	Senpais.Functions.Create.Elec_Locomotive( 3, "Senpais-Electric-Train-Heavy", MODNAME .. "/graphics/Senpais-Electric-Train-Heavy.png", 2000, 5000, 1.2, { r = 166, g = 26, b = 26 }, nil,
