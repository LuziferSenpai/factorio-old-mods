...
local function deep_layers(scale)
    return {
        {
...
local function animations(scale)
    return {
...
local function pipeconnection(connectiontype, position)
    return {
        production_type = connectiontype,
        base_area = t == "input" and 50 or 100000,
        base_level = t == "input" and -1 or 1,
        pipe_connections = {{type = connectiontype, position = position}},
...
item_item.order = "a[items]-ya[" .. deep_names[1] .. "]"
...
entity_item_mk2.name = deep_names[2]
...
entity_item_mk2.minable.result = deep_names[2]
...
item_item_mk2.name = deep_names[2]
item_item_mk2.order = "a[items]-yb[" .. deep_names[2] .. "]"
item_item_mk2.place_result = deep_names[2]

local recipe_item_mk2 = deep_copy(recipe_item)
recipe_item_mk2.name = deep_names[2]
recipe_item_mk2.ingredients = {
    {deep_names[1], 1},
    {"steel-chest", 10},
    {"processing-unit", 20}
}
recipe_item_mk2.result = deep_names[2]

--MK3
local entity_item_mk3 = deep_copy(entity_item)
entity_item_mk3.name = deep_names[3]
...
entity_item_mk3.minable.result = deep_names[3]
entity_item_mk3.entity_info_icon_shift = {0, -2}
entity_item_mk3.animation = animations(7)

local item_item_mk3 = deep_copy(item_item)
item_item_mk3.name = deep_names[3]
item_item_mk3.order = "a[items]-yc[" .. deep_names[3] .. "]"
item_item_mk3.place_result = deep_names[3]

local recipe_item_mk3 = deep_copy(recipe_item)
recipe_item_mk3.name = deep_names[3]
recipe_item_mk3.ingredients = {
    {deep_names[2], 1},
    {"steel-chest", 10},
    {"processing-unit", 20}
}
recipe_item_mk3.result = deep_names[3]
...
entity_fluid.name = deep_names[5]
entity_fluid.crafting_categories = {"deep-storage-fluid"}
entity_fluid.fluid_boxes = {
    pipeconnection("input", {0, -2}),
    pipeconnection("output", {0, 2}),
    off_when_no_fluid_recipe = false
}
entity_fluid.minable.result = deep_names[5]
...
item_fluid.name = deep_names[5]
item_fluid.order = "b[fluid]-ye[" .. deep_names[5] .. "]"
item_fluid.place_result = deep_names[5]

local recipe_fluid = deep_copy(recipe_item)
recipe_fluid.name = deep_names[5]
recipe_fluid.ingredients[1] = {"storage-tank", 10}
recipe_fluid.result = deep_names[5]

--Mk2
local entity_fluid_mk2 = deep_copy(entity_fluid)
entity_fluid_mk2.name = deep_names[6]
...
entity_fluid_mk2.fluid_boxes = {
    pipeconnection("input", {2, -3}),
    pipeconnection("input", {0, -3}),
    pipeconnection("input", {-2, -3}),
    pipeconnection("output", {2, 3}),
    pipeconnection("output", {0, 3}),
    pipeconnection("output", {-2, 3}),
    off_when_no_fluid_recipe = false
}
entity_fluid_mk2.minable.result = deep_names[6]
...
item_fluid_mk2.name = deep_names[6]
item_fluid_mk2.order = "b[fluid]-yf[" .. deep_names[6] .. "]"
item_fluid_mk2.place_result = deep_names[6]

local recipe_fluid_mk2 = deep_copy(recipe_fluid)
recipe_fluid_mk2.name = deep_names[6]
recipe_fluid_mk2.ingredients = {
    {deep_names[5], 1},
    {"storage-tank", 10},
    {"processing-unit", 20}
}
recipe_fluid_mk2.result = deep_names[6]

--Mk3
local entity_fluid_mk3 = deep_copy(entity_fluid)
entity_fluid_mk3.name = deep_names[7]
...
entity_fluid_mk3.fluid_boxes = {
    pipeconnection("input", {3, -4}),
    pipeconnection("input", {1, -4}),
    pipeconnection("input", {-1, -4}),
    pipeconnection("input", {-3, -4}),
    pipeconnection("output", {3, 4}),
    pipeconnection("output", {1, 4}),
    pipeconnection("output", {-1, 4}),
    pipeconnection("output", {-3, 4}),
    off_when_no_fluid_recipe = false
}
entity_fluid_mk3.minable.result = deep_names[7]
...
item_fluid_mk3.name = deep_names[7]
item_fluid_mk3.order = "b[fluid]-yg[" .. deep_names[7] .. "]"
item_fluid_mk3.place_result = deep_names[7]

local recipe_fluid_mk3 = deep_copy(recipe_fluid)
recipe_fluid_mk3.name = deep_names[7]
recipe_fluid_mk3.ingredients = {
    {deep_names[6], 1},
    {"storage-tank", 10},
    {"processing-unit", 20}
}
recipe_fluid_mk3.result = deep_names[7]
...
tech.effects = {
    ...
    {type = "unlock-recipe", recipe = deep_names[3]},
...
connector_entity.order = "IDONTKNOW"
...
if mods["Transport_Drones"] then
    ...
    entity_item_big.name = deep_names[4]
    ...
    entity_item_big.minable.result = deep_names[4]
    ...
    item_item_big.name = deep_names[4]
    item_item_big.order = "a[items]-yd[" .. deep_names[4] .. "]"
    item_item_big.place_result = deep_names[4]

    local recipe_item_big = deep_copy(recipe_fluid)
    recipe_item_big.name = deep_names[4]
    ...
    recipe_item_big.result = deep_names[4]

    table.insert(tech.effects, 4, {type = "unlock-recipe", recipe = deep_names[4]})

    local entity_fluid_big = deep_copy(entity_item_big)
    entity_fluid_big.name = deep_names[8]
    ...
    entity_fluid_big.minable.result = deep_names[8]
    ...
    item_fluid_big.name = deep_names[8]
    item_fluid_big.order = "b[fluid]-yh[" .. deep_names[8] .. "]"
    item_fluid_big.place_result = deep_names[8]

    local recipe_fluid_big = deep_copy(recipe_item_big)
    recipe_fluid_big.name = deep_names[8]
    recipe_fluid_big.ingredients[1] = {deep_names[5], 1}
    recipe_fluid_big.ingredients[3] = {"fluid-depot", 1}
    recipe_fluid_big.result = deep_names[8]

    table.insert(tech.effects, {type = "unlock-recipe", recipe = deep_names[8]})
