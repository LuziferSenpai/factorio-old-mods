...
function dsu:update_connector()
    if self.item then
        self.connector.get_or_create_control_behavior().set_signal(1, {signal = {type = "item", name = self.item}, count = mathmin(2147483647, mathmax(-2147483647, self:get_current_amount()))})
    end
end
